...
void renderBox(pcl::visualization::PCLVisualizer::Ptr &viewer, std::vector<Box3D> box, Color color = Color(1, 0, 0), float opacity = 1);
void renderBox(pcl::visualization::PCLVisualizer::Ptr &viewer, std::vector<BoxQ> bboxes, Color color = Color(1, 0, 0), float opacity = 1);
