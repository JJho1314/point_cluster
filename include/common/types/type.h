...
typedef pcl::PointXYZIL PointIL;
typedef pcl::PointCloud<PointIL> PointILCloud;
typedef PointILCloud::Ptr PointILCloudPtr;
typedef PointILCloud::ConstPtr PointILCloudConstPtr;
