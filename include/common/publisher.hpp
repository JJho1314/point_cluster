...
static void publishObjectsMarkers(
    ...
    for (size_t obj = 0u; obj < objects_array.size(); ++obj) {
         ...
         *      B   |   A-----------
         */
        //ROS_INFO("polygon size %lu", objects_array[obj]->polygon.size());
        // if (objects_array[obj]->ROI_Label == 0)
        // // if (true)
        // {
        //     visualization_msgs::Marker box, text_show;
        //     geometry_msgs::Point p;
        //     box.header = text_show.header = header;
        //     box.ns = text_show.ns = "objects";
        //     box.id = obj;
        //     //dir_arrow.id = obj + objects_array.size();
        //     text_show.id = obj + objects_array.size();
        //     box.type = visualization_msgs::Marker::LINE_LIST;
        //     text_show.type = visualization_msgs::Marker::TEXT_VIEW_FACING;
        //     //ROS_INFO("polygon size %lu", objects_array[obj]->polygon.size());
        //     std::vector<geometry_msgs::Point> index;
        //     double height = objects_array[obj]->height;
            
        //     for (size_t poi = 0u; poi<objects_array[obj]->polygon.size(); poi++)
        //     {
        //         if (objects_array[obj]->polygon[poi].x == 0 && objects_array[obj]->polygon[poi].y == 0)
        //         {}
        //         else
        //         {
        //             geometry_msgs::Point q;
        //             q.x = objects_array[obj]->polygon[poi].x;
        //             q.y = objects_array[obj]->polygon[poi].y;
        //             q.z = -2.0;
        //             index.push_back(q);
        //         }
        //     }
        ...
        //     for(int poi = 1; poi<index.size(); poi++)
        //     {
        //         p.x = index[poi].x;
        //         p.y = index[poi].y;
        //         p.z = -2.0;
        //         box.points.push_back(p);
        //         box.points.push_back(p);
        //         //ROS_INFO("polygon:%f, %f, %f",p.x, p.y, p.z);
        //     }
        //     p.x = index[0].x;
        //     p.y = index[0].y;
        //     p.z = -2.0;
        ...
        //     // for (size_t poi = 0u; poi<objects_array[obj]->polygon.size(); poi++)
        //     // {
        //     //     p.x = objects_array[obj]->polygon[poi].x;
        //     //     p.y = objects_array[obj]->polygon[poi].y;
        //     //     p.z = 0.0;
        //     //     box.points.push_back(p);
        //     //     if (poi != 0u)
        //     //     {
        ...
        //     //     // ROS_INFO("polygon:%f, %f, %f",p.x, p.y, p.z);
        //     // }
        //     //     p.x = objects_array[obj]->polygon[0].x;
        //     //     p.y = objects_array[obj]->polygon[0].y;
        //     //     p.z = -2.0;
        //     //     box.points.push_back(p);
        //     box.scale.x = 0.1;
        //     box.color = color;
        ...
        //     pose.position.x =  objects_array[obj]->ground_center[0];
        //     pose.position.y =  objects_array[obj]->ground_center[1];
        //     pose.position.z =  objects_array[obj]->ground_center[2] + height;
        //     text_show.pose=pose;

        //     double distance_ck = sqrt(objects_array[obj]->ground_center(0)*objects_array[obj]->ground_center(0) + objects_array[obj]->ground_center(1)*objects_array[obj]->ground_center(1));
        //     std::ostringstream str;
        //     str.precision(2);
        //     str.setf(std::ios::fixed);
        //     // add image label 
        //     int image_label = objects_array[obj]->object_type;
        //     //printf("************************ image_label  %d  \n", image_label);
        //     if( image_label == 0)
        //     {
        //         str<<" person";
        //     }
        ...
        //         str<<" car";
        //     }
        //     else if( image_label == 2)
        //     {
        //         str<<" bus";
        //     }
        //     else if( image_label == 3)
        //     {
        //         str<<" truck";
        //     }
        //     else if( image_label == 4)
        //     {
        //         str<<" bike";
        //     }
        //     else if( image_label == 5)
        //     {
        //         str<<" motor";
        //     }
        //     else if( image_label == 6)
        //     {
        //         str<<" traffic_cone";
        //     }
        //     else if( image_label == 7)
        //     {
        //         str<<" fence";
        //     }
        //     else
        ...
        //ROS_INFO("qian:%f,%f,%f",center[0],center[1],center[2]);
        ...
        //qian,hou,不变的,why??
        //ROS_INFO("hou:%f,%f,%f",center[0],center[1],center[2]);
        // object size
        ...
        box.header = dir_arrow.header =text_show.header= header;
        ...
        // box.color = color;
        box.color.a = 1.0;
        box.color.r=objects_array[obj]->color[0];
        box.color.g=objects_array[obj]->color[1];
        box.color.b=objects_array[obj]->color[2];
        // box.color.r = 0 / 255.0;
        // box.color.g = 255 / 255.0;
        // box.color.b = 255 / 255.0;
        ...
        // str << "d: "<<distance_ck<<"\n";
        // str << objects_array[obj]->cloud->size()<<"\n";
        // str << "v:" << ground_v;
        //str << "v:" << vy;
        // add image label 
        int image_label = objects_array[obj]->object_type;
        ...
        // str << " " << distance_ck << "m";
        if( image_label != -1)
            str <<  " "  << objects_array[obj]->track_id;
...
static void publishTrackingObjects(
    ...
    if (!tracking_objects.empty()) {
        ...
        for (size_t i = 0u; i < tracking_objects.size(); ++i) {
            ...
            // tracker id
            msg_tracking_objects.ids.push_back(obj->track_id);
            //image_label
            msg_tracking_objects.image_labels.push_back(obj->object_type);
            //image_position
            msg_tracking_objects.u_min.push_back(obj->u_min);
            msg_tracking_objects.v_min.push_back(obj->v_min);
            // position
            ...
            msg_tracking_objects.yaw.push_back(obj->yaw_rad);
            // size
            ...
            // ROI_Label
            msg_tracking_objects.ROI_Labels.push_back(obj->ROI_Label);
            // polygon
            sensor_msgs::PointCloud2 msg_polygon;
            PointICloudPtr cloud(new PointICloud);
            cloud->width = obj->polygon.size();
            cloud->height = 1;
            cloud->is_dense = false;
            cloud->points.resize(cloud->width * cloud->height);
            for (size_t ck = 0; ck < cloud->width; ck++)
            {
                cloud->points[ck].x = obj->polygon[ck].x;
                cloud->points[ck].y = obj->polygon[ck].y;
                cloud->points[ck].z = obj->polygon[ck].z;
                cloud->points[ck].intensity = obj->polygon[ck].intensity;
            }
            pcl::toROSMsg(*cloud, msg_polygon);
            msg_tracking_objects.polygon.push_back(msg_polygon);
