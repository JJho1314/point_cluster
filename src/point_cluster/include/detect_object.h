...
extern std::vector<cv::Scalar> _colors;
extern std_msgs::Header _velodyne_header;
...
public:
  ...
  void SetCloud_cluster(const pcl::PointCloud<pcl::PointXYZ> in_origin_cloud_cluster,
  ...
  void Building_BBox(const pcl::PointCloud<pcl::PointXYZ>::Ptr in_cloud_ptr,
                     pcl::PointCloud<pcl::PointXYZRGB>::Ptr out_cloud_ptr,
                     std::vector<int> cluster_indices, std::vector<int> cluster_index,
                     autoware_msgs::Centroids &in_out_centroids, autoware_msgs::CloudClusterArray &in_out_clusters, std_msgs::Header _velodyne_header);
